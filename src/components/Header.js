        ...
        <div className='container ' style={{ background: "#ffecec" }}>
            <ul className="nav flex-column">
                <li className="nav-item " >
                    <Link className="nav-link active  " aria-current="page" to={ROUTES.DASHBOARD}>
                ...
                <li className="nav-item">
                    <Link className="nav-link" to="#">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-25 h-25">
